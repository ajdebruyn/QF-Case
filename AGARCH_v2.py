# -*- coding: utf-8 -*-
"""
Created on Fri May 16 11:16:31 2025
...
# === Define negative log-likelihood function for asymmetric GARCH ===
def negative_log_likelihood(params, returns):
    mu, omega, alpha, alpha2, beta = params
    T = len(returns)
    sigma2 = np.zeros(T)
    eps = returns - mu
    ...
    for t in range(1, T):
        ...
        sigma2[t] = omega + (alpha + alpha2 * indicator) * eps[t-1]**2 + beta * sigma2[t-1]
